...
namespace Lab1
{
    class Program
    {
        private static string resourceFolder = "../../../Lab1/Resources/";
        private static string filePath = resourceFolder + "lab1.txt";

        private static string firstTaskAnswerPath = "answer1.txt";
        private static string secondTaskAnswerPath ="answer2.txt";
        ...
        private static void SolveFirstTask()
        {
            ...
            var pathToFile = Util.GetPathInProject("Resources\\answer1.txt");
        ...
        public static void WriteIndexesOfCoincidence(int maxOffset)
        {
            for (int i = 1; i < maxOffset; i++)
            {
                ...
                using (StreamWriter streamWriter = new StreamWriter(Util.GetPathInProject("Resources\\IndexesOfCoincidence.txt"), true))
                {
                    streamWriter.WriteLine("Shifted on : " + i + " , index of Coincidence  = " + indexCoincidence);
                }
            }
        }
